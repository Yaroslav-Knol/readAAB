...
**Как часто вы хотите обратиться к Учению, но страдаете от «свободы выбора» 🤣 — какую книгу открыть, какую главу выбрать?**
...
Приложение оснащено мощным алгоритмом полнотекстового поиска, специально адаптированным для работы со сложными текстами. Поисковик доступен отдельно в [веб-версии на Ryurik.space]([url](https://ryurik.space/records/search/trita)).
